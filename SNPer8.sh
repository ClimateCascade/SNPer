...
outdir=ddRAD8 #output directory
demultiplex=true
snp=false
barcodes=~/scahan/Aphaenogaster_RADfiles/ddRAD8.txt #formatted: GCATG<tab>03A
rads=~/scahan/Aphaenogaster_RADfiles/ddRAD8/scahan_2015_0514_ddRAD8_R1.fastq #unzipped file path
refmap= #~/indexes
