...
outdir=ddRAD3 #output directory
demultiplex=true
snp=false
barcodes=~/scahan/Aphaenogaster_RADfiles/ddRAD3.txt #formatted: GCATG<tab>03A
rads=~/scahan/Aphaenogaster_RADfiles/ddRAD3/scahan_2015_0514_ddRAD3_R1.fastq #unzipped file path
